...
Immer automatisch: `Automatic`, `DevBot CI`, `Publish`.
Forgejo-Labels werden gespiegelt (`Publish/Github` nicht).
**Release:** Label `releases/vX.Y.Z` → Tag + Packagist **erst nach Merge dieses PRs**.

### Changelog

Vor Release: Eintrag in `CHANGELOG.md` unter der Version (Keep a Changelog).
